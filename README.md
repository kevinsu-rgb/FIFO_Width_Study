...
3. Independent Clocks Block RAM, 8 bit Wr Port, 16 bit Rd Port, 32 (Vivado limits to 31) Write Depth, 16 (Vivado Limits to 15) Read Depth
4. Independent Clocks Block RAM, 512 bit Wr Port, 128 bit Rd Port, 16 Write Depth, 64 Read Depth
